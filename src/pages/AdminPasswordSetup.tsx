    ...
    return (
        <div className="min-h-screen bg-background flex items-center justify-center p-4">
            <div className="w-full max-w-md space-y-4">
                <Button variant="ghost" size="sm" onClick={() => navigate('/admin-signup')} className="gap-1.5 -ml-2">
                ...
                <Card className="border-2">
                    <CardHeader className="text-center pb-4">
                        ...
                        <CardDescription>Choose a strong password for your NGO admin account.</CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <p className="text-xs text-center text-muted-foreground">
                    After setup, your registration will be sent for Super Admin review.
                </p>
            </div>
        </div>
    )
